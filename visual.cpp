...
void init_simulation(Simulation &simulation)
{
    ...
    {
        Ref<Matrix<double, n_birds, 3, RowMajor>> starting_positions{simulation.states};
        ...
        while (window.isOpen() && iterations < simulation.rounds)
        {
            sf::Event event;
    ...
    else if (simulation.dimensions == 2)
    {
    }
}
